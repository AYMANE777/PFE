...
<img alt="repo-language-count" src="https://img.shields.io/github/languages/count/AYMANE777/PFE?style=flat&amp;color=0080ff" class="inline-block mx-1" style="margin: 0px 2px;">
...
<h3>Installation</h3>
<p>Build PFE from the source and intsall dependencies:</p>
<ol>
<li class="my-0">
<p><strong>Clone the repository:</strong></p>
<pre><code class="language-sh">❯ git clone https://github.com/AYMANE777/PFE
</code></pre>
</li>
<li class="my-0">
...
<h3>Testing</h3>
<p>Pfe uses the {<strong>test_framework</strong>} test framework. Run the test suite with:</p>
<p><strong>Using <a href="https://www.npmjs.com/">npm</a>:</strong></p>
